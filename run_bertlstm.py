...
# 设置logger
logging.basicConfig(filename='training_bertlstm3.log', level=logging.INFO, format='%(asctime)s %(message)s')
...
if __name__ == '__main__':
    ...
    model = Bert_lstm(len(labelIndex), criterion).to(device)
