...
# 设置logger
logging.basicConfig(filename='training_bertcnn.log', level=logging.INFO, format='%(asctime)s %(message)s')
...
if __name__ == '__main__':
    ...
    model = Bert_CNN(len(labelIndex), criterion).to(device)
